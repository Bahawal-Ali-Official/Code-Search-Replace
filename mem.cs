...
namespace Beyondmem
{
	...
	public class Escape
	{
		...
		private static extern void GetSystemInfo(out Escape.SYSTEM_INFO lpSystemInfo);
		[DllImport("kernel32.dll")]
		public static extern IntPtr OpenProcess(uint dwDesiredAccess, bool bInheritHandle, int dwProcessId);
		[DllImport("kernel32")]
		public static extern bool IsWow64Process(IntPtr hProcess, out bool lpSystemInfo);
		[DllImport("kernel32.dll")]
		private static extern bool VirtualProtectEx(IntPtr hProcess, UIntPtr lpAddress, IntPtr dwSize, Escape.MemoryProtection flNewProtect, out Escape.MemoryProtection lpflOldProtect);
		[DllImport("kernel32.dll")]
		...
		public static extern UIntPtr Native_VirtualQueryEx(IntPtr hProcess, UIntPtr lpAddress, out Escape.MEMORY_BASIC_INFORMATION64 lpBuffer, UIntPtr dwLength);
		[DllImport("kernel32.dll", EntryPoint = "VirtualQueryEx")]
		public static extern UIntPtr Native_VirtualQueryEx(IntPtr hProcess, UIntPtr lpAddress, out Escape.MEMORY_BASIC_INFORMATION32 lpBuffer, UIntPtr dwLength);
		...
		public string LoadCode(string name, string file)
		{
			...
			if (flag)
			{
				uint privateProfileString = Escape.GetPrivateProfileString("codes", name, "", stringBuilder, (uint)stringBuilder.Capacity, file);
			}
			else
			{
        ...
        public byte[] FuckedReader(string code, long length, string file = "")
        {
            byte[] array = new byte[length];
            UIntPtr code2 = this.GetCode(code, file, 8);
            bool flag = !Escape.ReadProcessMemory(this.pHandle, code2, array, (UIntPtr)(checked((ulong)length)), IntPtr.Zero);
            byte[] result;
            if (flag)
            {
                result = null;
        ...
        public Task<IEnumerable<long>> AoBScan(long start, long end, string search, bool readable, bool writable, bool executable, string file = "")
		{
			return Task.Run<IEnumerable<long>>(delegate ()
			{
				...
				Escape.SYSTEM_INFO system_INFO = default(Escape.SYSTEM_INFO);
				Escape.GetSystemInfo(out system_INFO);
				...
				Escape.MEMORY_BASIC_INFORMATION memory_BASIC_INFORMATION = default(Escape.MEMORY_BASIC_INFORMATION);
		...
		public void CloseProcess()
		{
			...
			if (!flag)
			{
				Escape.CloseHandle(this.pHandle);
				this.theProc = null;
			}
		}
		...
		private unsafe long[] CompareScan(MemoryRegionResult item, byte[] aobPattern, byte[] mask)
		{
			...
			ulong num;
			Escape.ReadProcessMemory(this.pHandle, item.CurrentBaseAddress, intPtr, (UIntPtr)((ulong)item.RegionSize), out num);
		...
		public UIntPtr VirtualQueryEx(IntPtr hProcess, UIntPtr lpAddress, out Escape.MEMORY_BASIC_INFORMATION lpBuffer)
		{
			bool flag = this.Is64Bit || IntPtr.Size == 8;
			UIntPtr result;
			if (flag)
			{
				Escape.MEMORY_BASIC_INFORMATION64 memory_BASIC_INFORMATION = default(Escape.MEMORY_BASIC_INFORMATION64);
				UIntPtr uintPtr = Escape.Native_VirtualQueryEx(hProcess, lpAddress, out memory_BASIC_INFORMATION, new UIntPtr((uint)Marshal.SizeOf(memory_BASIC_INFORMATION)));
			...
			{
				Escape.MEMORY_BASIC_INFORMATION32 memory_BASIC_INFORMATION2 = default(Escape.MEMORY_BASIC_INFORMATION32);
				UIntPtr uintPtr = Escape.Native_VirtualQueryEx(hProcess, lpAddress, out memory_BASIC_INFORMATION2, new UIntPtr((uint)Marshal.SizeOf(memory_BASIC_INFORMATION2)));
			...
			else
			{
				...
				else
				{
					...
					if (flag6)
					{
						...
						if (flag9)
						{
							Escape.ReadProcessMemory(this.pHandle, (UIntPtr)((ulong)((long)this.mainModule.BaseAddress + array4[0])), array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
						}
						else
						{
							...
							if (flag10)
							{
								...
								Escape.ReadProcessMemory(this.pHandle, (UIntPtr)((ulong)((long)value + array4[0])), array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
							}
							else
							{
								Escape.ReadProcessMemory(this.pHandle, (UIntPtr)((ulong)array4[0]), array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
							}
						}
						...
						for (int j = 1; j < array4.Length; j++)
						{
							...
							Escape.ReadProcessMemory(this.pHandle, uintPtr, array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
				...
				else
				{
					...
					else
					{
						...
						if (flag7)
						{
							...
							if (flag10)
							{
								Escape.ReadProcessMemory(this.pHandle, (UIntPtr)((ulong)((long)((int)this.mainModule.BaseAddress + array4[0]))), array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
							}
							else
							{
								...
								if (flag11)
								{
									...
									Escape.ReadProcessMemory(this.pHandle, (UIntPtr)((ulong)((long)((int)value + array4[0]))), array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
								}
								else
								{
									Escape.ReadProcessMemory(this.pHandle, (UIntPtr)((ulong)((long)array4[0])), array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
								}
							}
		...
		public bool WriteMemory(string code, string type, string write, string file = "", Encoding stringEncoding = null)
		{
			...
			return Escape.WriteProcessMemory(this.pHandle, code2, array, (UIntPtr)((ulong)((long)num)), IntPtr.Zero);
		}
		public bool IsAdmin()
		{
			bool result;
			...
			else
			{
				...
				else
				{
					try
					{
						...
						{
							this.pHandle = Escape.OpenProcess(2035711U, true, pid);
							...
							else
							{
								...
								this.GetModules();
								bool flag6;
								this.Is64Bit = (Environment.Is64BitOperatingSystem && Escape.IsWow64Process(this.pHandle, out flag6) && !flag6);
		...
		public bool ChangeProtection(string code, Escape.MemoryProtection newProtection, out Escape.MemoryProtection oldProtection, string file = "")
		{
			UIntPtr code2 = this.GetCode(code, file, 8);
			...
			if (flag)
			{
				oldProtection = (Escape.MemoryProtection)0U;
				result = false;
			}
			else
			{
				result = Escape.VirtualProtectEx(this.pHandle, code2, (IntPtr)(this.Is64Bit ? 8 : 4), newProtection, out oldProtection);
			}
			return result;
		}
